    ...
    <body>
            ...
            <div class='container'>
                ...
                <div class='trace-container'>
                    <div class='trace-header'>
                        ...
                        <span class='trace-layer-tag'>Laravel Bootstrap Layer</span>
                    </div>
        ...
        <script>
            ...
            function copyFullReport(btn) {
                ...
                const trace = document.getElementById('bootstrap-trace-text') ? document.getElementById('bootstrap-trace-text').innerText : '';

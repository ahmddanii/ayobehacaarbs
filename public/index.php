...
try {
    ...
    if ($e->getPrevious()) {
        ...
        $chainedInfo = "
            <div class='exception-message' style='background: rgba(24ab387, 250, 179, 0.08); border-left-color: #fab387; color: #fab387; margin-top: 16px;'>
        ...
        <div class='container'>
            ...
            <div class='trace-container'>
                <div class='trace-header'>
                    ...
                    <span style='color: #bac2de;'>Laravel Bootstrap Layer</span>
                </div>
